...
# Title and Icon
pygame.display.set_caption("ChessAI using minimax")
...
class Game:
    ...
    def __init__(self):
        ...
        self.p1_timer = Timer(1200, "bot")
        self.p2_timer = Timer(1200, "top")
    ...
    def determine_move(self):
        ...
        if self.p2_name == "Minimax":
            self.ai_move.put(AI.minimax(self.board.copy(), max_depth, -inf, inf, True, self.p2_color)[0])
        else:
